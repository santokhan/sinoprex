      ...
      <div class="flex gap-[2rem] text-center" role="card">
        <div class="w-full xl:w-1/2 flex flex-col gap-3">
          ...
          <div class="font-semibold text-stone-500 text-justify">
            If your projects requires real time solution which requires APIs or
            PlugIns we can do it for you.
          </div>
        </div>
        <div class="w-full xl:w-1/2 flex flex-col gap-3">
          <div class="flex justify-center">
          ...
          <div class="font-semibold text-stone-500 text-justify">
            We provide database solutions for online store , where you can store
            and use the data for later use.
          </div>
        </div>
      </div>
    </div>
