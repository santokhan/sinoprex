...
<template>
  <div
    class="flex justify-between items-center xl:h-[140px] px-4 lg:px-10 xl:px-[80px] py-3 sm:py-4 z-[900]"
    role="header"
  >
    ...
    <div class="font-medium relative z-[901]" role="dropdown">
      <button
        type="button"
        class="text-white bg-sky-400 hover:bg-sky-500x h-10 w-10 xl:h-12 xl:w-12 rounded-full shadow flex justify-center items-center p-3 xl:p-3"
